...
namespace SpacePlanning
{
    public class SplitObject
    {
        ...
        private static double spacingSet = 5;
        ...
        //RECURSIVE SPLITS A POLY
        [MultiReturn(new[] { "DeptPolys", "LeftOverPolys", "DepartmentNames" })]
        public static Dictionary<string, object> DeptSplitRefineChange(Polygon2d poly, List<DeptData> deptData,double offset, int recompute = 1)
        {
            /*
            get the poly
            get the poly area
        ...
        public static Dictionary<string, object> BasicSplitPolyIntoTwoUse(Polygon2d polyOutline, double ratio = 0.5, int dir = 0)
        {
            double extents = 5000;
