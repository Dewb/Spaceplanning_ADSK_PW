...
namespace SpacePlanning
{
    public class ReadInformation
    {
        ...
        internal ReadInformation(double a, double b)
        {
            _a = a;
            _b = b;
        }
        ...
        public static ReadInformation ByTestObjectMake(double a, double b)
        {
            return new ReadInformation(a, b);
        }
        ...
        public static List<Point> FromOutlineGetPoints(List<Autodesk.DesignScript.Geometry.NurbsCurve> nurbList)
        {
        ...
        private static void _makeSquaresFromPointList(Autodesk.DesignScript.Geometry.Point[] ptList)
        {
            double gridSize = 100;
            double flrHeight = 5;
        ...
        // private can be deleted
        private static List<Circle> _makeBubblesShape(Point[] ptList, List<List<string>> dataStack, double scale, Boolean tag)
        {
        ...
        //2
        public static List<double> NormalizedAreaCalculate(Point[] ptList, List<List<string>> dataStack, double scale, Boolean tag = true)
        {
            List<Circle> cirList = new List<Circle>();
            List<string> progAreaList = dataStack[3];
            List<string> progQuantList = dataStack[4];
        ...
        //private can be deleted later----------------------------------------------------
        private static Dictionary<string, object> _pushBubbles(List<Point> ptList, List<List<string>> dataStack, List<double> radiusListOrig,int iteration, double spacing)
        {
        ...
        private  Dictionary<string, object> _returnMultiExample(double a, double b)
        {
            return new Dictionary<string, object>
            {
                { "add", (a + b) },
