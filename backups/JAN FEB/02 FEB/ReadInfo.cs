...
namespace SpacePlanning
{
    public class ReadInfo
    {
        ...
        public static List<Circle> makeBubbles(Point[] ptList, List<List<string>> dataStack, double scale)
        {
            ...
            {
                double totArea = Convert.ToDouble(progAreaList[i]) * Convert.ToDouble(progQuantList[i]);
        ...
        public static List<List<int>> makeAdjacencyGraph(Point[] ptList, List<List<string>> dataStack, double scale)
        {
