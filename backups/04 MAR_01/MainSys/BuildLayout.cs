...
namespace SpacePlanning
{
    public class BuildLayout
    {
        ...
        private static double spacingSet = 50; // 0.5 worked great
        ...
        public static Dictionary<string, object> BasicSplitPolyIntoTwo(Polygon2d polyOutline, double ratio = 0.5, int dir = 0)
        {
            ...
            List<Point2d> intersectedPoints = GraphicsUtility.LinePolygonIntersectionNew(poly, splitLine);
        ...
        //worked better
        internal static List<Point2d> makePolyPointsStraightO(List<Point2d> poly, List<Point2d> intersectedPoints, List<int> pIndex)
        {
