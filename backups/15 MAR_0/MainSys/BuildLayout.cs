...
namespace SpacePlanning
{
    public class BuildLayout
    {
        ...
        public static Dictionary<string, object> CirculationMake(List<DeptData> deptData,List<List<Line2d>> lineListA, List<List<Line2d>> lineListB, double distance = 8, bool tag = true)
        {
        ...
        public static Line CheckLineMove(Line testLine, Point2d movePt)
        {
        ...
        internal static Dictionary<string, object> DeptSplitRefined(Polygon2d poly, List<DeptData> deptData, List<Cell> cellInside, double offset, int recompute = 1)
        {
            ...
            */
            ...
            if(leftOverPoly.Count > 0)
            {
                ...
                {
                    areaLeftOver += GraphicsUtility.AreaPolygon2d(leftOverPoly.Pop().Points);

                }
                AllDeptAreaAdded[1] += areaLeftOver;
                AllDeptPolys[1].AddRange(leftOverPoly);
            }
