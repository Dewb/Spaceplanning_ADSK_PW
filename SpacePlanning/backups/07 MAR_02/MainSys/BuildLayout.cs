...
namespace SpacePlanning
{
    public class BuildLayout
    {
        ...
        public static Dictionary<string, object> RecursiveSplitPolyPrograms(Polygon2d poly,List<ProgramData> progData, double ratioA = 0.5, int recompute = 1)
        {
            ...
            */
            ...
            {
                programDataRetrieved.Push(progData[i]);
            }
            polyRetrieved.Push(poly);
            int count = 0;
            //int thresh = 10;
    ...
    //RECURSIVE SPLITS A POLY
    [MultiReturn(new[] { "PolyAfterSplit", "AreaEachPoly", "EachPolyPoint","UpdatedProgramData" })]
    public static Dictionary<string, object> RecursiveSplitProgramsOneDirByDistance(Polygon2d poly,List<ProgramData> progData, double distance, int recompute = 1)
    {
