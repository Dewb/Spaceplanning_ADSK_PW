...
namespace SpacePlanning
{
    public class SplitObject
    {
        ...
        private static double spacingSet = 0.5;
        ...
        internal static List<Polygon2d> EdgeSplitWrapper(Polygon2d currentPoly, double distance, int dir, double dummy =0)
        {
            ...
            try
            {
                splitReturned = SplitByDistance(currentPoly, distance, dir, dummy);
                polyAfterSplitting = (List<Polygon2d>)splitReturned["PolyAfterSplit"];
            }
            catch (Exception)
            {
        ...
        internal static Dictionary<string, object> DeptSplitRefined(Polygon2d poly, List<DeptData> deptData, int recompute = 1)
        {
            ...
            for (int i = 0; i < sortedD.Count; i++)
            {
                ...
                if (i == 0)
                {
                    while (areaLeftOverToAdd > limit && leftOverPoly.Count > 0 && count1 < maxRound)
                    {
                        ...
                        currentPolyObj = leftOverPoly.Pop();
                        areaCurrentPoly = Polygon2d.AreaCheckPolygon(currentPolyObj);
                        List<Polygon2d> edgeSplitted = EdgeSplitWrapper(currentPolyObj, offset, dir,0.75); //////////////////////
                        ...
                        if(edgeSplitted == null)
                        {
                            ...
                            while(edgeSplitted == null && countTry < 300)
                            {
                                ...
                                edgeSplitted = EdgeSplitWrapper(currentPolyObj, offsetNew, dir, percentage);
        ...
        internal static Dictionary<string, object> BasicSplitPolyIntoTwoUse(Polygon2d polyOutline, double ratio = 0.5, int dir = 0)
        {
            double extents = 5000;
        ...
        //RECURSIVE SPLITS A POLY
        [MultiReturn(new[] { "PolyAfterSplit", "AreaEachPoly", "EachPolyPoint" })]
        internal static Dictionary<string, object> RecursiveSplitByAreaUse(Polygon2d poly, double area,int dir, int recompute = 1)
        {
        ...
        internal static Dictionary<int, object> pointSelector(List<Point2d> poly)
        {
        ...
        [MultiReturn(new[] { "PolyAfterSplit", "SplitLine", "IntersectedPoints", "SpansBBox", "EachPolyPoint" })]
        internal static Dictionary<string, object> SplitByDistance(Polygon2d polyOutline, double distance = 10, int dir = 0, double dummy =0)
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            Dictionary<int, object> obj = pointSelector(poly);
